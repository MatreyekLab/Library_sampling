...
```{r Get a z-score on this stuff}
nudt15 <- read.csv(file = "NUDT15_missense.csv", header = TRUE, stringsAsFactors = FALSE)
...
pten <- read.csv(file = "PTEN_library_distribution.csv", header = TRUE, stringsAsFactors = TRUE)
...
ggsave(file = "Fraction_of_uniform_distribution_plot.png", Fraction_of_uniform_distribution_plot, height = 3, width = 4)
...
ggsave(file = "Real_data_nudt15_pten_comparison_plot.png", nudt15_pten_comparison_plot, height = 3, width = 4)
nudt15_pten_comparison_plot
```

```{r Can I recreate the distribution using the a log-normal approximation?}
...
nudt15_fitted_distribution_plot
  ggsave(file = "nudt15_fitted_distribution_plot.png", nudt15_fitted_distribution_plot, height = 3, width = 4)
...
ggsave(file = "pten_fitted_distribution_plot.png", pten_fitted_distribution_plot, height = 3, width = 4)
...
ggsave(file = "Recreated_data_nudt15_pten_comparison_plot.png", nudt15_pten_comparison_plot, height = 3, width = 4)
nudt15_pten_comparison_plot
```
